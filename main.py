...
# db.create_all()
# for num in range(23):
#     new_product = Product(category="Italian", name="Tikka pizza", image="https://images.app.goo.gl/Kn9KxQN3MkxatQHUA", veg=True, price="100", payment_id="asdfasf")
#     db.session.add(new_product)
#     db.session.commit()
# new_user = User(name="Ajaykumar", email="ajaykumarnadarblackpanther@gmail.com", password="pbkdf2:sha256:260000$fxsLIC5m$cecc93e4ff1c588a374e9d74bf46fd74958430e52fb059886dd76345447073c3", cart={})
...
def cart():
    ...
    return render_template("cart.html", cart_data=cart_data, total_data=total_price)
